...
def populate():
    ...
    songs = [
        ...
        {'title': 'Tú Eres Ajena', 'artist': 'Eddy Herrera', 'genre': 'Merengue', 'album': 'Atrevido','duration': 5 ,'image': 'static/img/Ajena.png', 'release_date': '2021-05-01', 'file_url': 'https://www.youtube.com/watch?v=L_M8XP0nVFM&ab_channel=ForYourRelaxOnly', 'playlist': Playlist.objects.get(name='MerengeLatino')},
        {'title': 'El Tamarindo', 'artist': 'Kinito Mendez', 'genre': 'Merengue', 'album': 'Los éxitos de Kinito Mendez','duration': 5 ,'image': 'static/img/Tamarindo.png', 'release_date': '2021-05-01', 'file_url': 'https://www.youtube.com/watch?v=UEY7bagwQbU&ab_channel=carlitoswey', 'playlist': Playlist.objects.get(name='MerengeLatino')},
