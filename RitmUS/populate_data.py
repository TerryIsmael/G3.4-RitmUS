...
def populate():
    ...
    orders = [
        {'user': CustomUser.objects.get(username='usuario1'), 'purchase_date': '2023-11-01T00:00:00+01:00'},
        {'user': CustomUser.objects.get(username='usuario1'), 'purchase_date': '2023-12-04T17:50:01+01:00'},
        {'user': CustomUser.objects.get(username='usuario1'), 'purchase_date': '2023-12-06T11:00:00+01:00'},
        {'user': CustomUser.objects.get(username='usuario2'), 'purchase_date': '2023-12-07T23:59:00+01:00'},
    ]
    ...
    subscriptions = [
        ...
        {'init_date': '2023-12-07T23:59:00+01:00', 'end_date': '2024-01-06T23:59:00+01:00', 'price': 20, 'is_favourite': False, 'playlist': Playlist.objects.get(name='Like BlackPink'), 'order': Order.objects.filter(user=CustomUser.objects.get(username='usuario2'))[0]},
    ]
